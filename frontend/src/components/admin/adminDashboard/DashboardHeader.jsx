...
export function DashboardHeader({
  ...
  return (
    <header className="rounded-2xl border border-outline-variant/20 bg-surface-container-lowest dark:bg-surface-container-low p-3 tablet:px-4 tablet:py-3 shadow-level-1 flex flex-col gap-3.5 tablet:flex-row tablet:items-center tablet:justify-between w-full shrink-0">
      <div className="flex items-center gap-3.5 min-w-0">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-headline-lg-mobile tablet:text-headline-lg font-bold tracking-tight text-on-surface">
              Dashboard Admin
            </h1>
      ...
      <div className="flex items-center gap-2 shrink-0 flex-wrap tablet:flex-nowrap">
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full bg-success/10 border border-success/25 px-3 py-1 text-label-caps font-bold text-success shadow-2xs">
          <span className="h-2 w-2 rounded-full bg-success animate-pulse" />
          <span>Live Sync</span>
        </span>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-primary/10 border border-primary/20 px-3 py-1 text-label-caps font-bold text-primary font-mono shadow-2xs">
