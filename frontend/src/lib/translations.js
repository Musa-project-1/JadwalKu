...
export const TRANSLATIONS = {
  id: {
    ...
    'tasks.empty_title': 'Tidak ada tugas',
    'tasks.empty_desc': 'Semua tugas telah diselesaikan atau belum ada tugas yang ditambahkan.',
    ...
    'exams.empty_title': 'Belum ada jadwal ujian',
    'exams.empty_desc': 'Jadwal ujian untuk semester ini belum dipublikasikan oleh bagian akademik.',
  ...
  en: {
    ...
    'tasks.empty_desc': 'All tasks are completed or no tasks have been added yet.',
    ...
    'exams.empty_title': 'No exams scheduled yet',
    'exams.empty_desc': 'Exam schedules for this semester have not been published by academic staff.',
